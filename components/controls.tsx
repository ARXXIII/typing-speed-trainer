    ...
    return (
        <div className="flex justify-center items-center gap-x-6 absolute top-1/4 p-3 font-medium rounded-lg bg-zinc-800/30">
            ...
            <button onClick={() => handleWordCountChange(10)} className={clsx('text-neutral-500/60 hover:text-neutral-400 transition-colors',
                wordCount === 10 && 'text-yellow-400'
            )}>
                10
            </button>
            <button onClick={() => handleWordCountChange(25)} className={clsx('text-neutral-500/60 hover:text-neutral-400 transition-colors',
                wordCount === 25 && 'text-yellow-400'
            )}>
                25
            </button>
            <button onClick={() => handleWordCountChange(50)} className={clsx('text-neutral-500/60 hover:text-neutral-400 transition-colors',
